...
\newcommand{\emmail}[2]{\href{mailto:#1@#2}{#1@#2}}

\title{TFE4101 Krets- og Digitalteknikk}
\author{Håvard Krogstie\\\email{krogstie.havard}{gmail.com}}
\date{\today}
...
\noindent
Dette dokumentet inneholder forklaringer, definisjoner og formler brukt i Krets-
og Digitalteknikk våren 2020 (Den med Corona). I tillegg forklares en del
metoder. Dette er ikke et komplett kompendie, men kan brukes til oppslag og
oppfriskning. Ting kommer i en grei  rekkefølge, men noen formler og regler
brukes før de defineres. Dokumentet har ikke figurer for alt, så det er greit å
ha et indre bilde av kretser. I kretsdelen står blant annet grunnleggende
kretsteori, metoder for regning på kretser og formler for kondensatorer og
spoler. I digitalteknikkdelen kommer dioder og transistorer, CMOS, logiske
kretser, boolsk algebra, binærtallsregning, timing av digitale kretser og
...
\subsubsection{Toerkomplement-operasjonen}\ref{sec:toerkomplement-op}
...
Seksjon~\ref{sec:ripple_carry_fulladder} om ripple-carry-adder for eksempel på
propagering av mente.
...
input.
\newcommand{\mult}{\red{1}\green{1}\blue{0}\orange{1}\purple{1}}
%
\[10010 \times \mult\]
%
...
\begin{center}
  \begin{tabular}{ll}
    $1111110010 \times \mult$ & $(-14)\times(-5)$ \\
    \midrule
    0000000000 & partielt produkt \\
    1111110010 & multiplikand $\times\ 2^0 \times \purple{1}$ \\
    \midrule
    1111110010 & partielt produkt \\
    1111100100 & multiplikand $\times\ 2^1 \times \orange{1}$ \\
    \midrule
    1111010110 & partielt produkt \\
    0000000000 & multiplikand $\times\ 2^2 \times \blue{0}$ \\
    \midrule
    1111010110 & partielt produkt \\
    1110010000 & multiplikand $\times\ 2^3 \times \green{1}$ \\
    \midrule
    1101100110 & partielt produkt \\
    0011100000 & multiplikand $\times\ {-2^4} \times \red{1}$ \\
    \midrule
    0001000110 & $70_{10}$ \\
    \bottomrule
    \bottomrule
