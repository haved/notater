...
tilstand er uavhengig av forige tilstand, eller i tilfeller der man med ord kan
...
\begin{table}[hbt!]
  ...
  \begin{minipage}{.4\textwidth}
    ...
    \begin{tabular}{cc|ccc}
      ...
      S & R & Q & $\bar{\text{Q}}$ & \\
      \midrule
      0 & 0 & \multicolumn{2}{c}{Uendret} & \vspace{2\baselineskip} \\
      \midrule
      1 & 0 & 1 & 0 & \vspace{2\baselineskip} \\
      \bottomrule
    \end{tabular}
